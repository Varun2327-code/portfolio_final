      ...
      <div className={styles.container}>
        ...
        <div className={styles.left}>
          <span className={styles.logo}>
            <span className={styles.logoV}>V</span>PORTFOLIO
          </span>
          <p className={styles.copy}>
            &copy; {year} Varun Shrimal · Dungarpur, Rajasthan, India
          </p>
        </div>
        ...
        <div className={styles.center}>
          ...
          <p className={styles.poweredBy}>
            Powered by{' '}
            <a
              href="https://kiruvartechnology.in/"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.kiruvarLink}
            >
              Kiruvar Technology
            </a>
          </p>
